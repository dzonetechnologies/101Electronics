...
Route::get('/care', [HomeController::class, 'CareRepair'])->name('CareRepairRoute');
...
Route::get('/return-n-cancellations', [HomeController::class, 'ReturnCancellations'])->name('ReturnCancellationsRoute');
Route::get('/ways-to-pay', [HomeController::class, 'WaysToPay'])->name('WaysToPayRoute');
Route::get('/delivery-options', [HomeController::class, 'DeliveryOptions'])->name('DeliveryOptionsRoute');
...
Route::get('/privacy-cookie-policy', [HomeController::class, 'PrivacyPolicy'])->name('PrivacyPolicyRoute');
