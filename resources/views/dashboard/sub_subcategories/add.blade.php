                                    ...
                                    <div class="row">
                                        <div class="col-12 mb-3">
                                            ...
                                            <input type="text" placeholder="Title" id="title"
                                                   ...
                                                   onkeyup="CheckForDuplicateTitle(this.value, 'sub_subcategories');"
                                                   onblur="CheckForDuplicateTitle(this.value, 'sub_subcategories');"
                                                   required>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <select id="category" name="category" class="form-control select2"
                                                    onchange="GetSubcategoriesFromCategories(this.value);" required>
