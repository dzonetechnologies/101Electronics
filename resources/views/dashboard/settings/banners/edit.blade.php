        ...
        <div class="row">
            <div class="offset-md-2 col-md-8">
                <div class="card">
                    ...
                    ?>
                    <div class="card-body">
                        <form action="{{ route('settings.banners.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="offset-md-1 col-md-10">
                                    ...
                                    {{--Mobile Banner--}}
                                        ...
                                        ?>
                                        <input type="hidden" name="page_id" value="{{$PageId}}">
                                        <input type="hidden" name="oldPageBannerImageMobile" value="{{$PageDetails[0]->banner_img_mobile}}">
                                            <div class="row">
                                                <div class="offset-md-1 col-md-10">
                                                    <div class="row">
                                                        <div class="col-12 mb-3">
