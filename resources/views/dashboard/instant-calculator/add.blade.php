                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            <div>
                                <h4 class="mb-3 mb-md-0">Instant Calculator - Create</h4>
                            </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('instantcalculator.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="offset-md-2 col-md-8">
                                    <div class="row">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-12 mb-3 mt-3">
                                                                                ...
                                                                                <input type="number" name="month" class="form-control"
                                                                                       placeholder="No. of Months" min="0" required autocomplete="off" />
                                                                            </div>
                                                                            <div class="col-md-12">
