        ...
        <div class="container">
            <div class="row mt-4 mb-5">
                ...
                <div class="col-md-12 mb-5 d-none d-md-block">
                  <img src="{{asset('public/storage/page-banners/' . $PageDetails[0]->banner_img)}}" width="100%" height="150" alt="Installment Guide Banner Image">
                </div>
                @endif
                @if(isset($PageDetails[0]->banner_img_mobile))
                    <div class="col-md-12 mb-5 d-md-none">
                        <img src="{{asset('public/storage/page-banners/' . $PageDetails[0]->banner_img_mobile)}}" width="100%" height="150" alt="Installment Guide Banner Image">
                    </div>
                @endif
                <!-- Content -->
                <div class="col-md-12">
